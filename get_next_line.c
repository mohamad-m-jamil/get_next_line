...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/27 12:11:53 by mjamil            #+#    #+#             */
/*   Updated: 2024/06/27 19:07:37 by mjamil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(char *temp, char *read_buf);
...
void	read_line(int fd, char **buffer, char **temp)
{
	...
	while (bytes_read > 0)
	{
		...
		*buffer = ft_strjoin(*temp, read_buf);
